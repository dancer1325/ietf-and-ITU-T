...
Status of This Memo
   ...
   https://www.rfc-editor.org/info/rfc9939.
...
1.  Introduction
   ...
   with one PrivateKeyInfo and one EncryptedPrivateKeyInfo.  These
   content type assignments are needed for the PrivateKeyInfo and
...
3.  ASN.1 Module
   ...
   The ASN.1 module [X680] [X690] in this section builds upon the
   modules in [RFC5911].
