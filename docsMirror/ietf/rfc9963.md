https://www.rfc-editor.org/rfc/rfc9963.txt
...
3.  PKCS #1 v1.5 SignatureScheme Types
   ...
   negotiate the use of these signature algorithms with keys that
   ...
   might result in a message to the user or have other side effects.
